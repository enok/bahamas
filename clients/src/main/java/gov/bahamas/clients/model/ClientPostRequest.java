 ...
 */
@ApiModel(description = "Business objects that represents a response from Client creation.")
@JsonPropertyOrder({
  ClientPostRequest.JSON_PROPERTY_CLIENT
})
@JsonTypeName("clientPostRequest")
...
public class ClientPostRequest {
  ...
  public ClientPostRequest client(Client client) {
